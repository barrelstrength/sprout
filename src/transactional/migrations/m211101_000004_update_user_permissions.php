...
class m211101_000004_update_user_permissions extends Migration
{
    ...
    {
        $permissionMap = [
            'sprout-module-transactional' => [
                'sproutEmail-viewNotifications' => 'sprout-module-transactional:viewTransactionalEmail',
                'sproutEmail-editNotifications' => 'sprout-module-transactional:editTransactionalEmail',
                'sproutForms-viewNotifications' => 'sprout-module-transactional:viewTransactionalEmail',
                'sproutForms-editNotifications' => 'sprout-module-transactional:editTransactionalEmail',
            ],
        ];
