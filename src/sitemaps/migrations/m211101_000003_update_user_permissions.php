...
class m211101_000003_update_user_permissions extends Migration
{
    public function safeUp(): void
    {
        $permissionMap = [
            'sprout-module-sitemaps' => [
                'sproutSitemaps-editSitemaps' => 'sprout-module-sitemaps:editSitemaps',
                'sproutSeo-editSitemaps' => 'sprout-module-sitemaps:editSitemaps',
            ],
        ];
    ...
    {
        echo "m211101_000003_update_user_permissions cannot be reverted.\n";
