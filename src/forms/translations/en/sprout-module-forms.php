...
return [
    ...
    'Integration types define the integrations that will be available to use in your forms. Limit which integrations can be used for a given Form Type.' => 'Integration types define the integrations that will be available to use in your forms. Limit which integrations can be used for a given Form Type.',
    ...
    'Actions' => 'Actions',
    'Workflows' => 'Workflows',
    'This page lists any transactional email that are known to be related to the events triggered by this form. Manage all of your transactional email via the Email tab.' => 'This page lists any transactional email that are known to be related to the events triggered by this form. Manage all of your transactional email via the Email tab.',
    'Invalid secret key.' => 'Invalid secret key.',
    'Defines how to check a form submission to determine if a user has opted in to have data sent to this Integration. The Integration will be sent if the setting is set to \'Always\'; if an Opt-in field is selected and a user confirms they wish to opt-in; or if the Custom Rule is
         used and evaluates to \'1\', \'true\', \'on\', or \'yes\'. If none of those conditions are met, the Integration will not be sent.' => 'Defines how to check a form submission to determine if a user has opted in to have data sent to this Integration. The Integration will be sent if the setting is set to \'Always\'; if an Opt-in field is selected and a user confirms they wish to opt-in; or if the Custom Rule is
         used and evaluates to \'1\', \'true\', \'on\', or \'yes\'. If none of those conditions are met, the Integration will not be sent.',
    'Workflow' => 'Workflow',
    ...
    'Create your first integration' => 'Create your first integration',
    'Advanced' => 'Advanced',
    'Send your form submission data to somewhere other than Craft.' => 'Send your form submission data to somewhere other than Craft.',
    'Data Sets' => 'Data Sets',
    'Filesystems' => 'Filesystems',
    'Integration types define how your form data can be mapped and sent to other places.' => 'Integration types define how your form data can be mapped and sent to other places.',
    'Integration types define the integrations that will be available to use in your forms. Limit which integrations can be used for a given Form Type when configuring your Form Types.' => 'Integration types define the integrations that will be available to use in your forms. Limit which integrations can be used for a given Form Type when configuring your Form Types.',
    'Couldn\'t reorder Integration Types.' => 'Couldn\'t reorder Integration Types.',
    'New Integration' => 'New Integration',
    'This setting is defined by the selected integration type and is not editable.' => 'This setting is defined by the selected integration type and is not editable.',
    ...
    'Integration types define the integrations that will be available to use in your forms. Configure your Form Types to limit which integrations are allowed for a given form workflow.' => 'Integration types define the integrations that will be available to use in your forms. Configure your Form Types to limit which integrations are allowed for a given form workflow.',
    ...
    'Integration types define how your form data is mapped and send to other places.' => 'Integration types define how your form data is mapped and send to other places.',
    'New Data Set...' => 'New Data Set...',
    'Select Data Set Type...' => 'Select Data Set Type...',
    ...
    'Integration types define the integrations that will be available to your forms. Use Form Types to select which integrations are available to a given form.' => 'Integration types define the integrations that will be available to your forms. Use Form Types to select which integrations are available to a given form.',
    'Edit Integrations' => 'Edit Integrations',
    'Field Rules' => 'Field Rules',
    'The Integration will be sent if the setting is set to \'Always\'; if an Opt-in field is selected and a user confirms they wish to opt-in; or if the Custom Rule is used and evaluates to \'1\', \'true\', \'on\', or \'yes\'. If none of those conditions are met, the Integration will not be sent.' => 'The Integration will be sent if the setting is set to \'Always\'; if an Opt-in field is selected and a user confirms they wish to opt-in; or if the Custom Rule is used and evaluates to \'1\', \'true\', \'on\', or \'yes\'. If none of those conditions are met, the Integration will not be sent.',
    ...
    'To create a new {name}' => 'To create a new {name}',
    'Create your form' => 'Create your form',
    'Add a field' => 'Add a field',
    'Name is required' => 'Name is required',
    'Continue to form builder' => 'Continue to form builder',
    'Next' => 'Next',
    'Create Form' => 'Create Form',
