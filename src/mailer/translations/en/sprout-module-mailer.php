...
return [
    ...
    'This setting is defined by the form type and is not editable.' => 'This setting is defined by the form type and is not editable.',
    'This setting is not editable.' => 'This setting is not editable.',
    'New Mailer Settings' => 'New Mailer Settings',
    'Form Themes' => 'Form Themes',
    'Email types define the fields, .' => 'Email types define the fields, .',
    'Create custom mailer settings to refine email type workflows. The Craft [Email Settings]({emailSettingsCpUlr}) will be used by default.' => 'Create custom mailer settings to refine email type workflows. The Craft [Email Settings]({emailSettingsCpUlr}) will be used by default.',
    'Templates' => 'Templates',
    'Create custom mailer settings to refine email type workflows. The Craft <a href="{url}">Email Settings</a> will be used by default.' => 'Create custom mailer settings to refine email type workflows. The Craft <a href="{url}">Email Settings</a> will be used by default.',
    'Create additional mailer configurations to customize email type workflows. The default Craft Mailer Settings will be used.' => 'Create additional mailer configurations to customize email type workflows. The default Craft Mailer Settings will be used.',
    ...
    'Create custom mailer settings to refine email type workflows. The default Craft Mailer Settings will be used.' => 'Create custom mailer settings to refine email type workflows. The default Craft Mailer Settings will be used.',
    'Create custom mailer settings to refine email type workflows. The Craft <a href="{url">Email Settings</a> will be used by default.' => 'Create custom mailer settings to refine email type workflows. The Craft <a href="{url">Email Settings</a> will be used by default.',
    ...
    'Create custom mailer settings to refine email type workflows. The Craft Mailer Settings will be used by default.' => 'Create custom mailer settings to refine email type workflows. The Craft Mailer Settings will be used by default.',
    'Customize your email workflow  new Mailer Settings to custom email types. The default Craft Mailer Settings will be used.' => 'Customize your email workflow  new Mailer Settings to custom email types. The default Craft Mailer Settings will be used.',
